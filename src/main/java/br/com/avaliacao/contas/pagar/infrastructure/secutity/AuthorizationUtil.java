...
public class AuthorizationUtil {
    ...
    static void addAuthentication(String username, HttpServletResponse response) {
        ...
        response.addHeader("issued", strNow);
        response.addHeader("expires", strAfter);
    }
    ...
    private static String makeToken(String subject, Date issued, Date expires) {
        JwtBuilder jwtBuilder = Jwts.builder()
                ...
                .signWith(
                        ...
                        DatatypeConverter.parseBase64Binary(SecurityConstants.PRIVATE_KEY)
                );
    ...
    private static Claims decode(String token) {
        ...
        try {
            claims = Jwts.parser()
                    .setSigningKey(DatatypeConverter.parseBase64Binary(SecurityConstants.PRIVATE_KEY))
